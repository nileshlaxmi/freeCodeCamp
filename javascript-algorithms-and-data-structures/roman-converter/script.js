const romanConverter = () => {
    let numStr = document.getElementById('ipText').value;
    ...
    if (index !== -1) {
        ...
        if (len >= 5) {
            document.getElementById('opText').innerText = "Number should be less than 10K"
        }
        else {
            if (len > 3) {
                d = parseInt(ar[0]);
    ...
    document.getElementById('opText').innerText = output;
}
